        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-arch-gray">
              Dönüştürücü tasarım tutkusuyla kurulan stüdyomuz, ilham veren ve kalıcı alanlar yaratmak için mimarlıktaki en iyi düşünceleri bir araya getiriyor. Düşünceli tasarımın hayatı ve toplumu geliştirme gücüne inanıyoruz.
            </p>
            <div className="pt-4">
              <Link 
                to="/about" 
